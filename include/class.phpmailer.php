...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'facultyrec.iiitdm@gmail.com';//'root@localhost';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Faculty Recruitment Admin';//'Root User'
   ...
   * @var string
   */
  public $Sender            = 'facultyrec.iiitdm@gmail.com';//'';
   ...
   * @var string
   */
  public $Username      = 'facultyrec.iiitdm@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'easytoguess';
